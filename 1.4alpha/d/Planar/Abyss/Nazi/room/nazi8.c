/*
** File: /d/Planar/Abyss/Nazi/room/nazi8.c
...
EndText
    ...
    set( "exits", ([
      "south" : "/d/Planar/Abyss/Nazi/room/nazi7.c",
      "west" : "/d/Planar/Abyss/Nazi/room/nazi9.c",
      "east" : "/d/Planar/Abyss/Nazi/room/nazi14.c",
    ]) );
    set("item_desc", ([
    ]) );
}
