...
void create() {
    ...
    if(!perms) perms = ([ ]);
    set("light", 1);
    set( "short", "A foul smelling mist" );
    set ("long", "@@query_long");
    set( "smell", "The mist smells toxic and burns your nostrils.\n" );
    set( "c_long", @EndText
You find yourself in a foul smelling mist.
You think you may be in Gasman's bathroom.
EndText
    );
    set("item_desc", ([
...
int check_prot(object person, string cmd) {
    ...
    if (getuid(person)=="gasman") return 1;
