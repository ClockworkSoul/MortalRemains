...
**  sometime 99 Nightmask changed yet again for Bard's (suck it)
**  Camels rule
*/
...
int cmd_backstab(string targ) {
  ...
  write("You are not permitted to attack that.\n") ;
   ...
   if (bksb) {
     ...
     bksb = clone_object("/d/class/bard/obj/BACKSTABED.c");
      if (!bksb) {
...
//write("level="+level+"\n"); 
   ...
   switch (level) {
      case 0 : break;
      case 1..8 : multiplier+=6; break;
      case 9..16 : multiplier+=9; break;
      case 17..24 : multiplier+=12; break;
      case 25..29 : multiplier+=15; break;
      default : multiplier+=18; break;
  }
