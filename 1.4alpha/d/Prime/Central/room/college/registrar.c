...
// Lots of chrome by Cyanide, Oct 18 98.
// Cyanide turned it into the registrar's office, 31 Jul 99
...
void create()
{
    ...
    seteuid( getuid() );
    set( "light", 1 );
    set("short", CITY_NAME+" Community College Registrar");
    set("long", wrap("This is the "+CITY_NAME+" Community College "+
	"office of the registrar. Here, all manner of classes are "+
	"offered in a variety of fields.\n\nThe commands are: list, "+
	"select <letter>") );
    set("author", "cyanide");
    set( "exits", ([
      "west" : COLLEGE("campus"),
