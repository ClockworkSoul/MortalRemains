...
#define MARRIAGE_FILE "/d/attic/Outer/Sigil/marriages.o"
...
void create() {
    ...
    seteuid(getuid()) ;
    /*
	set ("objects", ([ "justice" : "/d/attic/Sigil/monsters/justice" ]) );
	reset();
    */
    set ("light", 1) ;
    set("short", "The Courhouse of Sigil.") ;
    set ("long",
      "These are the Grand courts of Sigil.\n"+
      "Where the law is kept, people are married,\n"+
      "And where the Guvners has it's Headquarters.\n");
    set ("exits", ([
      "east" : SIGIL+"ladyst2.c",
      "west" : SIGIL+"petitionerst2.c",
      "up" : SIGIL+"court2.c" ]));
    seteuid(getuid()) ;
    numpending = 0 ;
    pending = allocate(10) ;
