/*
** FILE: summon5.c (Monster Summoning III)
...
int cast_summon5 (string str, int obj) {
	...
	write("You begin casting Monster Summoning V...\n");
	say(TPN+" traces runes of conjuration upon the ground.\n");
    }

    monster = CATALOG_D->get_random_mon(14, 17);
...
string spellcraft() {
    return (@EndSpell
Monster Summoning V (Level VI Wizard Spell - Summoning)
