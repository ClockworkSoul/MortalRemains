...
//                 Cyanide (28 Mar 97) Added level support.
//                 Cyanide (10 Aug 97) Added class/dual class support.
//
...
mapping domains, Class, Class_old;
mixed *passwd_fail;
int wizard, last_on, dead, hibernate, level, level_old;
	...
	switch (what) {
		...
		case "cap_name" :
			return (name ? capitalize(name) :"Logon");
                case "level" : return (level ? level : 0); //Cyanide
                case "Class" : return(Class?Class:(["none":"peasant"]));
                case "Class_old" : return (Class_old ?
                      Class_old : (["none":"peasant"]) );
                case "level_old" : return(level_old?level_old : 0);
...
//    }
        switch (what) {
                case "level" : level = val; break; //Cyanide 4 Mar 97
                case "level_old" : level_old = val; break;
                case "Class" : Class = val; break;
                case "Class_old" : Class_old = val; break;
