...
void create() {
    ...
    set("long", wrap( 
	"You are in the "+MUD_NAME+" post office. You can send mail from here, "+
	"and if other people send you mail, you can read it also. "+
	"There is a sign on the wall that you could read also."
      ) );
    set("light",1) ;
    set ("exits", ([ "west" : "/d/Ancients/rooms/wizrm.c" ]) ) ;
...
int read_sign (string str) {
    ...
    write (
      ...
      "saying whether you prefer the \"Old Cyanide\" stamp or the \"Young Cyanide\"\n"+
