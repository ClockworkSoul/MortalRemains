/* This is Room 6 of the Rock Tunnel leading from
...
plentiful here. A very large mass of webbing
is obvious to the west.
EndText
        );

set( "exits", ([
"east" : SPD_ROOM+"spcave17.c",
"west" : SPD_ROOM+"spcave19.c",
        ]) );
    ...
    gtspidey->move(TO);
set("item_desc", ([
    "ceiling" : "The cieling is made of smooth obsidian rock.\n",
