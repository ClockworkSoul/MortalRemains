...
/* This is Room 10 in Tyran's Spider Caves
Coded on 7/19/2000*/
...
set( "exits", ([
"west" : SPD_ROOM+"spcave09.c",
"northwest" : SPD_ROOM+"spcave11.c",
"north" : SPD_ROOM+"spcave12.c",
"south" : SPD_ROOM+"spcave07.c",
"southwest" : SPD_ROOM+"spcave06.c",
        ]) );
