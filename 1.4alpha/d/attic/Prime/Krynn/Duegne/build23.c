...
set("long",@Endtext
You stand on the front porch of the Dragon's Blood Inn. There
...
set("exits", ([
"east"  :  "/d/Prime/Krynn/Duegne/road3.c",
"door"  :  "/d/Prime/Krynn/Duegne/common.c",
"window" : "/d/Prime/Krynn/Duegne/common1.c",
]));
set("post_exit_func", ([
