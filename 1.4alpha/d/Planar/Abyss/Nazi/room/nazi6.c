/*
** File: /d/Planar/Abyss/Nazi/room/nazi6.c
...
EndText
    ...
    set( "exits", ([
      "north" : "/d/Planar/Abyss/Nazi/room/nazi7.c",
      "south" : "/d/Planar/Abyss/Nazi/room/nazi2.c",
      "east" : "/d/Planar/Abyss/Nazi/room/nazi3.c",
      "west" : "/d/Planar/Abyss/Nazi/room/nazi11.c",
    ]) );
    set("item_desc", ([
    ]) );
    reset();
...
void reset() {
	...
	s3 = clone_object(NAZI_MON+"soldiers.c" );
	s3->move(this_object());
