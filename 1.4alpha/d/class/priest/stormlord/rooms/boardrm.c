...
void create()
{
    ...
    seteuid(getuid());
    set( "light", 1 );
    set("short", "The Board Room of the Stormlords");
    set( "long", @EndText
...
EndText
    ...
    set( "exits", ([
      "north" : "/d/class/priest/stormlord/rooms/priest_guild.c",
    ]) );
    call_other("/d/class/priest/stormlord/obj/board", "blah");
}
...
int receive_object(object ob) {
	...
	if (ob->query_level("stormlord")) return 1;
	tell_object(ob, "You hit an invisible wall of force.\n"+
	  "A voice tells you: Only priests may enter this place.\n");
	return 0;
    }
    return 1;
}
