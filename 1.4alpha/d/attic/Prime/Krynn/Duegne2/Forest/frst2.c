...
midst. You are able to see that the path continue to the northwest
...
set("exits", ([
"northwest"  :  "/d/Prime/Krynn/Duegne2/Forest/frst3.c",
"southeast"  :  "/d/Prime/Krynn/Duegne2/Forest/frst1.c",
]));
::create();
}
