...
switch(str) {
case "world war ii" :
room = "/d/Planar/Abyss/Nazi/room/nazy1.c"; break;

case "pool party" :
room = "/u/n/nsd/library/cyberparty/pool.c"; break;

case "start" :
room = START; break;

case "suite lust" :
room = "/u/n/nsd/lust/suite.c"; break;

case "sauna inferno" :
room = "/u/n/nsd/library/sauna/sauna1.c"; break;

case "book binding" : 
monster = clone_object("/u/n/nsd/library/binder.c");
if (monster) {
