...
laid down to create a solid walkway for travelers.  Directly west is
one of the supporting towers for the main structure, surrounded by a 
flower garden on the ground level.  To the north and south are skywalks
reaching from the main tower to other buildings on the outside of the 
town square.
EndText
);
  set( "exits", ([
	"east" : "/u/c/chakan/edge/streets/r14.c",
	"northwest" : "/u/c/chakan/edge/square/r2.c",
	"southwest" : "/u/c/chakan/edge/square/r4.c",
  ]) );
...
"towers"  :
"There are three supporting towers visible from here.  one immediately\n"+
"west and one to the northwest and southwest.  Each are huge in their\n"+
