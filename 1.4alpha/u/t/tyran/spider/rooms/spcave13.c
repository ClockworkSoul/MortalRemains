/* This is Room 1 of the Rock Tunnel leading from
...
void create ()
{
        ...
        set( "long", @EndText
   The spacious caves have turned into a long,
curving tunnel.  The walls have turned from a dull
grey to black in color.  The spiderwebs are more
pronounced and plentiful here.
EndText
        );

set( "exits", ([
"southwest" : SPD_ROOM+"spcave10.c",
"west" : SPD_ROOM+"spcave12.c",
"east" : SPD_ROOM+"spcave14.c"
        ]) );
