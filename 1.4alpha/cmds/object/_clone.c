...
// Cyanide@MR (9/19/99) Added 'cloned_by' property setting.
*/
...
int cmd_clone(string str) {
    ...
    // Added this for security. 
    // Cyanide, 19 Sept 1999
    ob->set("cloned_by", TP->query("name"), LOCKED);
	...
	write(" to " + file_name(this_player()) + ".\n");
    }

    if (ob && living(ob) && CATALOG_D->catalog_monster(ob))
	write("This monster has been added to the summoning catalog.\n"+
	  "Please contact Cyanide if you need it removed.\n");
