...
#define MARRIAGE_FILE M_DATA+"marriages.o"
...
void create() {
    ...
    seteuid(getuid()) ;
    set("objects", ([
      "justice" : M_MON + "justice.c",
    ]) );
    set ("light", 1) ;
    set("short", "The Courthouse of "+CITY_NAME+".");
    set ("long",
      "This is the High Court of "+CITY_NAME+".  You can come here to get\n"+
      "married if you so chose to, but be aware that with marriage\n"+
      "come's responsibility and trust.  Divorce will have its\n"+
      "consequences, but you will have to wait until then to find out\n"+
      "what that exactly is.  You see here that there is a desk,\n"+
      "some chairs, and a couch with some man sitting on it in the\n"+
      "corner\n");
set("item_desc", ([
"desk" : "there appears to be a letter on the desk that says, WHAT TO DO IN THE EVENT OF A DIVORCE!!\n",
"man" : "This man appears to be the Father of a very beautiful young woman, and he is watching your every move for some reason!!\n",
]) );
    set ("exits", ([
    ]) );
    seteuid(getuid()) ;
...
void add_pending(string str) {
    ...
    numpending = numpending + 1 ;
    write("Your proposal has been noted by the justice.\n") ;
