...
#define COST 60
#define SUMMON ({ \
  "/d/Inner/monsters/waterelem.c" \
  })

inherit SPELL;

int invoke_summonwater (string str, int obj) {
...
Summon Water Elemental (Priest - Level VII - Summoning, Water)

Duration: permanent 	
Cost: 60 TP

	This spell summons a water elemental to aid
